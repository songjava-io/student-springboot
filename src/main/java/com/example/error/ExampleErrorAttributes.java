...
public class ExampleErrorAttributes implements ErrorAttributes, HandlerExceptionResolver, Ordered {

	final Logger logger = LoggerFactory.getLogger(getClass());
	
	private static final String ERROR_INTERNAL_ATTRIBUTE = ExampleErrorAttributes.class.getName() + ".ERROR";
	...
	public Throwable getError(WebRequest webRequest) {
		...
		logger.error("getError exception", exception);
		if (exception == null) {
